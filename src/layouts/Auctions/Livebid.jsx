...
import Bidders from "../../components/Auctions/Bidders";
  ...
  return (
    <div className="container mx-auto md:pb-16">
      <div className="max-w-[1064px] mx-auto ">
        <p className="text-[#BCB7B7] hidden md:block my-8">
          <Link to="/">Home</Link>/ <Link to="/auctions">Auctions</Link>/{" "}
          <span className="text-grey">Live bid</span>{" "}
        </p>
        <main className="h-screen w-full border border-black flex">
          <div className="w-full md:w-1/2 overflow-hidden h-full flex flex-col justify-between relative text-white p-4 md:p-8">
            <img
              src={currentBid && currentBid.url}
              alt=""
              className="w-full min-h-full absolute -z-10 top-0 left-0"
            />
            ...
            <div className="hidden md:flex justify-between items-center w-full">
              ...
              <span className="bg-[#4693ED] text-xl rounded-[1.25rem] py-1 px-8 font-inter font-medium ">
                LIVE
              </span>
            </div>
            ...
            <div className="flex items-center gap-2 md:hidden text-medium text-white leading-[157%]">
              ...
              <span className="bg-[#006CA2] rounded-[5px] text-[13px] py-1 px-3">
                LIVE
              </span>
              <span className="bg-white/[0.4] text-[13px] rounded-[5px] py-1 px-2 flex items-center">
                ...
                >
                  <path
                    d="M7.59961 7.19998C8.70418 7.19998 9.59961 6.30455 9.59961 5.19998C9.59961 4.09541 8.70418 3.19998 7.59961 3.19998C6.49504 3.19998 5.59961 4.09541 5.59961 5.19998C5.59961 6.30455 6.49504 7.19998 7.59961 7.19998Z"
                    fill="white"
                  />
                  <path
        ...
        <section className="mt-8 hidden md:block">
          <Link to="/drop">
            <button className="flex  items-center gap-4 text-2xl text-black leading-[178%] font-medium">
              See upcoming drops
              <svg
                width="60"
                height="60"
