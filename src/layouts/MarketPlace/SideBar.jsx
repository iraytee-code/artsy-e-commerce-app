...
const SideBar = () => {
  ...
  return (
    <Fragment>
      <aside className="w-[244px] shrink-0 hidden lg:block ml-3">
        ...
        <div className="mb-8">
          <CategoryTitle title="By Category" />
        ...
        <div className="my-8">
          <CategoryTitle title="By artist" />
          <div className="transition-all overflow-hidden">
            <p className="underline mb-4 cursor-pointer">All</p>
            <p className="mb-4 last:mb-0 cursor-pointer">Below $100.00</p>
            <p className="mb-4 last:mb-0 cursor-pointer">$100.00 - $150.00</p>
            <p className="mb-4 last:mb-0 cursor-pointer">$150.00 - $200.00</p>
            <p className="mb-4 last:mb-0 cursor-pointer">Above $200.00</p>
          </div>
        </div>
        <div className="mb-4">
          <CategoryTitle title="Collection year" />
          <div></div>
        </div>
      </aside>
    </Fragment>
