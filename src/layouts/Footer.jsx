  ...
  return (
    <footer className={className}>
      <div className="container mx-auto text-xl leading-[35px] pb-4 text-[#333333] flex justify-between">
        <h1 className="hidden md:block font-clash font-semibold leading-[59px] text-grey-dark text-2xl flex items-center">
          ARTSY.
        </h1>
        ...
        <ul className="text-sm md:text-xl">
          ...
          <li className="flex items-center mb-[14px] md:mb-4">
            <svg
              className="h-6 w-6 md:h-[61px] md:w-[54px]"
              width="61"
              height="54"
              viewBox="0 0 61 54"
              fill="none"
      ...
      <p className="hidden md:block text-center -spacing-[0.02em] text-[#333333]/[0.5] text-sm font-medium font-rubik mt-10 mb-11">
