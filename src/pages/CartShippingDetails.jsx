    ...
    <div className={`max-w-[1064px] px-4 md:px-0 mx-auto pb-8`}>
      ...
      <main className="flex gap-16 justify-end">
        <form
          ...
          className="w-full md:w-0  grow-0 overflow-hidden"
        >
          <InputWrapper>
            ...
            <label
              htmlFor="checkbox"
              className="text-sm ml-3 mt-3 inline-block"
            >
          ...
          <div className="flex items-center mt-8 gap-4 md:gap-8">
            ...
            <InputWrapper>
              <label htmlFor="postcode" className="block -mt-6">
                Postal code
              </label>
              <input
                type="number"
          ...
          <Link to="/cart" className="md:hidden">
            <span className="text-lg underline text-[#006CA2] block text-center my-7">
              Go Back to cart
            </span>
          </Link>
        </form>
