...
import PhantomRounded from "../assets/images/wallets/Phantom-rounded.png";
import WalletConnectRounded from "../assets/images/wallets/WalletConnect-rounded.png";
import CoinbaseRounded from "../assets/images/wallets/Coinbase-rounded.png";
import MetaMaskRounded from "../assets/images/wallets/MetaMask-rounded.png";
      ...
      <div className={`max-w-[1064px] mx-auto pb-8 px-4 md:px-0`}>
        ...
        <main>
          <div className="flex  items-center justify-between mb-8">
            <h3 className="text-grey-dark text-xl leading-[150%] hidden md:block">
              Payment Method
            </h3>
          ...
          <div className="flex gap-4">
              ...
              <section className="md:shadow-[0px_0px_5px_rgba(0,0,0,0.25)] rounded-[0.5rem] md:p-8">
                <div className="flex items-center">
                  <input
                    ...
                    id="select-wallet"
                    checked={true}
                    className="mr-3 accent-[#28A814]"
                  />
                  <label
                    htmlFor="select-wallet"
                    className="text-grey-dark text-xl"
                  >
                    Select your wallet
                  </label>
                ...
                <p className="text-[#616161] text-lg leading-[157%] mt-3 mb-4">
                ...
                <InputWrapper>
                  <input
                    ...
                    name="saveWallet"
                    id="saveWallet"
                    value={formData.saveWallet}
                    onChange={handleSwitch}
                  />
                  <label
                    htmlFor="saveWallet"
                    className="text-sm ml-3 mt-3 md:inline-block"
                  >
            ...
            <aside className="w-1/2 p-8 hidden md:block">
              <h3 className="text-grey-dark text-lg font-medium border-b border-b-[0.3px] pb-6 border-b-[#747474]">
                Payment Summary
              </h3>
              <article className="py-8 border-b-[0.3px] border-b-[#747474]">
                <p className="text-grey-dark">
                  Metamask wallet : {formData.walletKey}
                </p>
                <p className="text-sm text-[#616161] mt-4">
              ...
              <article className="leading-[150%] text-grey-dark leading-[157%] py-6 border-b-[0.3px] border-b-[#747474]">
                <p>
                  Expected arrival date: Between 22nd January and 26th January
                  2023
                </p>
              </article>
