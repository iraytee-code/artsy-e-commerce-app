...
import eclipse1 from "../assets/images/eclipse/Ellipse-14.png";
import eclipse2 from "../assets/images/eclipse/Ellipse-15.png";
import eclipse3 from "../assets/images/eclipse/Ellipse-16.png";
import eclipse4 from "../assets/images/eclipse/Ellipse-17.png";
import eclipse5 from "../assets/images/eclipse/Ellipse-18.png";
  ...
  return (
    <div className="relative flex flex-col lg:flex-row border-t border-t-grey border-t-[0.5px] py-8 md:py-[60px] lg:even:flex-row-reverse first:border-t-0 lg:first:border-t last:border-b border-b-grey border-b-[0.5px]  lg:border-b-0">
      ...
      <article className="lg:w-1/2 flex flex-col justify-between text-grey lg:mr-[50px]">
        <h4 className="text-[30px] md:text-[2.5rem] font-semibold w-full text-center lg:text-left lg:font-bold font-clash lg:font-stix absolute text-white lg:text-grey absolute top-12 md:top-20 lg:relative lg:top-0">
        ...
        <div className="flex items-center">
          <div className="mr-[15px]">
            <EllipseImage img={eclipse1} />
            <EllipseImage img={eclipse2} />
            <EllipseImage img={eclipse3} />
            <EllipseImage img={eclipse4} />
            <EllipseImage img={eclipse5} />
          </div>
