...
function Bidders({ classes }) {
  ...
  return (
    <>
      <div
        className="h-[calc(100%_-_85.11px)] overflow-y-scroll pb-4"
        ref={bidContainer}
      >
        {listOfBidders}
        <div
          ref={likesContainer}
          className={"like-container absolute h-2/3 md:h-1/3 " + classes}
        ></div>
      </div>
      <div>
        <p className="text-[#BAB9B9] leading-[157%] font-medium italic mb-1 hidden md:block">
          ...
          <div className="h-9 md:h-[3.5rem] w-[80%] bg-transparent md:bg-gradient-to-r from-[#78A3AD] to-[#C056097D] flex items-center justify-center rounded-[1.25rem]">
            <div className="h-[calc(100%_-_2px)] w-[calc(100%_-_2px)]  md:bg-white rounded-[1.25rem] overflow-hidden pl-4 pr-2 flex items-enter border border-white md:border-0">
              <input
                ref={inputBox}
                type="text"
                className="h-full w-full focus:outline-0 font-medium text-white md:text-[#616161] text-sm md:text-lg bg-transparent"
                placeholder="Place a bid..."
              />
              <svg
                onClick={submitBid}
                className="h-9 w-9 md:w-[54px] md:h-[51px] mr-4 md:mr-0"
                width="54"
                height="51"
                viewBox="0 0 54 51"
                fill="none"
              ...
              >
                <path
                  className="fill-white md:fill-grey-dark"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="shape"
                    result="effect1_innerShadow_560_201"
                  />
                </filter>
              </defs>
            </svg>
